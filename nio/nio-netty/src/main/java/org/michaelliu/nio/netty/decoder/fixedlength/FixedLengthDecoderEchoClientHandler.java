 ...
 */
public class FixedLengthDecoderEchoClientHandler extends ChannelHandlerAdapter {

    private static final Logger logger = Logger.getLogger(
            FixedLengthDecoderEchoClientHandler.class.getName());
     ...
     */
    public FixedLengthDecoderEchoClientHandler(String message) {
